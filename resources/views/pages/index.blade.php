...
<body>
  ...
  <!-- Nav Start /-->
  @include('layouts.compartment.navIndex')
  <!-- Nav End /-->

  <!-- Registration Start /-->
  @include('layouts.compartment.register')
  <!-- Registration End /-->
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-body-c">
              <p class="content-c">
                You can looking for a property here with our amazing agents.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-body-c">
              <p class="content-c">
                You can post your proterty here for sell.
              </p>
            </div>
            <div class="card-footer-c">
              <a href="#" class="link-c link-icon">Read more
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">Showing selling property</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
                Here are all the selling property.
              </p>
            </div>
            <div class="card-footer-c">
              <a href="property-grid" class="link-c link-icon">Read more
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
          </div>
              ...
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single/{{$property->property_id}}">{{$property->property_name}}</a>
                  </h2>
                </div>
